...
namespace CromulentBisgetti.ContainerPacking.Algorithms.EBAFIT
{
    /// <summary>
    ...
    {
        private const int AlgorithmID = (int)AlgorithmType.EB_AFIT;
        private const string AlgorithmName = "EB-AFIT";
        ...
        {
            itemsToPack = new List<Item>(items.Count + 1);
            itemsPackedInOrder = new List<Item>(items.Count + 1);
